...
export default function Home() {
  return (
    <main className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-black text-white px-4">
      <div className="z-10 flex flex-col items-center justify-center text-center relative px-4 sm:px-6 md:px-10 w-full max-w-4xl mt-[-10vh]">
        ...
        <BlurFade delay={0.75} inView>
          <p className="mt-6 sm:mt-8 md:mt-12 text-gray-300 text-lg md:text-xl md:leading-relaxed mb-6 max-w-3xl font-light mx-auto">
        ...
        <BlurFade delay={0.85} inView>
          <p className="mt-4 sm:mt-6 md:mt-8 text-gray-300 text-lg md:text-xl md:leading-relaxed mb-12 max-w-3xl font-light mx-auto">
