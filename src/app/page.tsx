...
export default function Home() {
  return (
    <main className="relative flex min-h-[100dvh] w-full flex-col items-center justify-center overflow-hidden bg-black text-white px-4 pb-24 md:pb-0">
      <div className="z-10 flex flex-col items-center justify-center text-center relative px-4 sm:px-6 md:px-10 w-full max-w-4xl mt-[-8vh] md:mt-[-10vh]">
        ...
        <BlurFade delay={0.75} inView>
          <p className="mt-8 md:mt-10 text-gray-300 text-lg md:text-xl md:leading-relaxed max-w-3xl font-light mx-auto">
        ...
        <BlurFade delay={0.85} inView>
          <p className="mt-6 md:mt-8 text-gray-300 text-lg md:text-xl md:leading-relaxed max-w-3xl font-light mx-auto">
